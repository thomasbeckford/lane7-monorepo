...
const sectionVariants = {
  ...
  background: {
    ...
    accent: "bg-accent/50",
    brand:
      "bg-gradient-to-br from-brand-50 to-brand-100 dark:from-brand-900/20 dark:to-brand-800/10",
  },
};
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("text-center space-y-4 mb-12 max-w-3xl mx-auto", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <h2
    ref={ref}
    className={cn("text-display-lg font-bold tracking-tight", className)}
    {...props}
  />
));
